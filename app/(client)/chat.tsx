...
export default function ChatScreen() {
  ...
  const freelancerName = params.freelancerName as string
  ...
  const fetchChat = useCallback(async (shouldSetLoading = true) => {
    ...
    try {
      ...
      if (response.status === 'success' && mountedRef.current) {
        ...
        // Store user ID to determine message alignment
        setUserId(response.data.chat.client._id)
    ...
    const setupSocketListeners = async () => {
      ...
      try {
        ...
        const unsubTyping = await socketService.on('user_typing', (data) => {
          if (data.chatId === chatId && data.userId === freelancerId && mountedRef.current) {
      ...
      <ThemedView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerInfo}>
            <ThemedText style={styles.freelancerName}>{freelancerName}</ThemedText>
        ...
        {isTyping && (
          <View style={styles.typingContainer}>
            <ThemedText style={styles.typingText}>{freelancerName} is typing...</ThemedText>
          </View>
        )}
