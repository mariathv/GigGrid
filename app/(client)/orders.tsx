  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <View style={styles.tabsContainer}>
        ...
        >
          <ThemedText style={[styles.tabText, activeTab === "completed" && styles.activeTabText]}>Completed</ThemedText>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.tab, activeTab === "cancelled" && styles.activeTab]}
          onPress={() => setActiveTab("cancelled")}
        >
          <ThemedText style={[styles.tabText, activeTab === "cancelled" && styles.activeTabText]}>Cancelled</ThemedText>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.ordersContainer}>
        {isLoading ? (
          ...
          <View style={styles.emptyStateContainer}>
            ...
            {activeTab !== "active" && (
              <TouchableOpacity style={styles.browseButton} onPress={() => setActiveTab("active")}>
